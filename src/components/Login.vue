  ...
  <div class="container-fluid form-body">
    <transition name="slide">
      <div class="container-fluid login-form" v-show="isShow">
        ...
        <p class="error" v-if="errorMsg1">Username Or Password Not Correct</p>
        ...
        <div class="row" style="text-align: center">
          <div class="col-12" v-on:click="slidetoggle">
            Hasn,t Account <a href="#"> Register Now!!</a>
          </div>
        </div>
      </div>
    </transition>
    ...
    <transition name="slide">
      <div class="container-fluid register-form" v-show="!isShow">
        ...
        <p class="error" v-if="errorMsg2"></p>
        <div class="form-floating row form-border">
          <input
            type="text"
            class="form-control"
        ...
        <div class="row" style="text-align: center">
          <div class="col-12" v-on:click="slidetoggle">
            Has Account<a href="#"> Login Now!!</a>
          </div>
        </div>
      </div>
    </transition>
